...
<?foreach ($arResult["SHOW_FIELDS"] as $FIELD):?>
	...
	{
		case "PASSWORD":
			?><input placeholder="<?=GetMessage("REGISTER_FIELD_".$FIELD)?>" size="30" type="password" name="REGISTER[<?=$FIELD?>]" value="<?=$arResult["VALUES"][$FIELD]?>" autocomplete="off" class="bx-auth-input" />
...
<?
		...
		case "CONFIRM_PASSWORD":?>
			...
			<div class="input-text"><?=GetMessage("PASSWORD_WARNING")?></div>
			<?
			break;
		...
		case "PERSONAL_PHOTO":
		case "WORK_LOGO":
			?><input placeholder="<?=GetMessage("REGISTER_FIELD_".$FIELD)?>" size="30" type="file" name="REGISTER_FILES_<?=$FIELD?>" /><?
			break;
		...
		default:
			...
			<?if($FIELD == "LOGIN"){?>
				<input placeholder="<?=GetMessage("REGISTER_FIELD_".$FIELD)?>" size="30" type="hidden" name="REGISTER[<?=$FIELD?>]" value="<?=$arResult["VALUES"][$FIELD]?>" class="REGISTER-<?=$FIELD?>"/>
			<?}else{?>
				<input placeholder="<?=GetMessage("REGISTER_FIELD_".$FIELD)?>" size="30" type="text" name="REGISTER[<?=$FIELD?>]" value="<?=$arResult["VALUES"][$FIELD]?>" class="REGISTER-<?=$FIELD?>"/>
			<?}?>
...
if ($arResult["USE_CAPTCHA"] == "Y")
{
	?>
			...
			<input type="text" name="captcha_word" maxlength="50" value="" autocomplete="off" placeholder="<?=GetMessage("REGISTER_CAPTCHA_PROMT")?>" />
