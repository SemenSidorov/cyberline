...
if (empty($arResult['ERROR_MESSAGE']))
{
	...
	?>
	<div id="basket-root" class="bx-basket row bx-<?=$arParams['TEMPLATE_THEME']?> bx-step-opacity" style="opacity: 0;">
		<?
		if (
		...
		)
		{
			...
			<div class="row col-lg-3">
				<div class="col-xs-12" data-entity="basket-total-block"></div>
				<div class="basket-bottom col-xs-12">
					<div class="bottom-text" style="border-top: 1px solid #dadada; padding: 15px 0 15px; margin-top: 10px;">
						<p>Если у вас уже есть клубная карта, то <a class="button-user-login">авторизируйтесь</a> , чтобы воспользоваться.</p>
						<!-- <p>А если у вас ещё нет клубной карты, можете: <a href="#">получить или активировать клубную карту</a></p> -->
					</div>
					<div class="buttons"><button class="add-basket-to-favorites">Добавить все в избранное</button> <button class="remove-basket">Очистить корзину</button></div>
				</div>
			</div>		
			<?
		}
