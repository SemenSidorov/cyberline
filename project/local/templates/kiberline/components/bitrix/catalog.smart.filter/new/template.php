...
<div class="bx-filter <?if ($arParams["FILTER_VIEW_MODE"] == "HORIZONTAL") echo "bx-filter-horizontal"?>">
	<div class="bx-filter-section container-fluid" style="background: #f8f8f8;">
				...
				<?foreach($arResult["ITEMS"] as $key=>$arItem)//prices
				{
					...
					if(isset($arItem["PRICE"])):
						...
						<div class="<?if ($arParams["FILTER_VIEW_MODE"] == "HORIZONTAL"):?>col-sm-6 col-md-4<?else:?>col-lg-12<?endif?> bx-filter-parameters-box bx-active">
							...
							<div class="bx-filter-parameters-box-title" onclick="smartFilter.hideFilterProps(this)"><span>Цена, <?=$arItem["NAME"] == "RUB" ? "₽" : $arItem["NAME"]?> <i data-role="prop_angle" class="fa fa-angle-<?if ($arItem["DISPLAY_EXPANDED"]== "Y"):?>up<?else:?>down<?endif?>"></i></span></div>
							<div class="bx-filter-block" data-role="bx_filter_block">
								<div class="row bx-filter-parameters-box-container">
									...
									<div class="col-xs-12 bx-ui-slider-track-container no-padding">
				...
				<div class="col-xs-12 bx-filter-button-box">
					<div class="bx-filter-block">
						<div class="bx-filter-parameters-box-container">
							<input
								style="color: #005dc4;border: 1px solid #005dc4;margin-bottom: 10px;width: 100%;padding: 10px 0;-webkit-border-radius: 4px;-moz-border-radius: 4px;border-radius: 4px;font-size: 15px;background: none;cursor: pointer;"
							...
							/>
							<input
								style="color: #858585;border: 1px solid #858585;width: 100%;padding: 10px 0;-webkit-border-radius: 4px;-moz-border-radius: 4px;border-radius: 4px;font-size: 15px;background: none;cursor: pointer;"
								class="btn btn-link"
								type="submit"
								id="del_filter"
								name="del_filter"
